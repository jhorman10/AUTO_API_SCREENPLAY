 ...
 *   int actualCode = actor.asksFor(ResponseStatus.code());
 */
public class ResponseStatus implements Question<Integer> {
    ...
    /**
     * Factory method para crear una pregunta sobre el código de estado
     * 
     * @return Question que retorna el código HTTP
     */
