...
/**
 * ConversionId - Question que extrae el ID de la conversión creada desde la respuesta POST
 * 
 * Ejemplo de uso: String id = actor.asksFor(ConversionId.fromLastResponse())
 */
