...
/**
 * FetchConversionById - Tarea para obtener una conversión específica vía GET /api/v1/conversions/{id}
 * 
 * Responsabilidad única: Enviar una petición GET con el ID de la conversión.
 */
public class FetchConversionById implements Task {
    ...
    /**
     * Factory method para crear una tarea de FetchConversionById
     */
    public static FetchConversionById withId(String id) {
        return Instrumented.instanceOf(FetchConversionById.class)
            .withProperties(id);
    }
    
    public FetchConversionById withProperties(String id) {
        return this;
    }
}
